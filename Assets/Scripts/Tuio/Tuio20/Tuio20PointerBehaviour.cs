...
namespace TuioSimulator.Tuio.Tuio20
{
    public class Tuio20PointerBehaviour : TuioTransform
    {
        ...
        public void Init(Tuio20Manager tuioManager, Vector2 startPosition)
        {
            ...
            Pointer = new Tuio20Pointer(TuioTime, container, 0, 0, Translation.Position.FromUnity(), 0f, 0f, 0f, 0f, Vector2.zero.FromUnity(), 0f, 0f, 0f);
            _manager.AddEntity(Pointer);
        }

        protected override void UpdateTuio()
        {
            Pointer.Update(TuioTime, 0, 0, Translation.Position.FromUnity(), 0f, 0f, 0f, 0f, Translation.Velocity.FromUnity(), 0f, 0f, 0f);
        }
